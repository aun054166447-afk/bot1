...
# ==================== CONFIGURATION ====================
BOT_TOKEN = "8930988272:AAHlBKz3CKW10hTJgkfiV5JXOmHLFPcSdug"
GITHUB_TOKEN = ''
...
async def start(message):
    ...
    # ALWAYS_PAID_USERS ထဲတွင် ပါဝင်ပါက အလိုအလျောက် Paid User အဖြစ် သတ်မှတ်မည်[span_1](start_span)[span_1](end_span)
...
async def perform_check(session_url, code, chat_id, scan_id=None, recheck=False, message=None):
    ...
    post_url = base64.b64decode(
        b'aHR0cHM6Ly9wb3J0YWwtYXMucnVpamllnemV0d29ya3MuY29tL2FwaS9hdXRoL3ZvdWNoZXIvP2xhbmc9ZW5fVVM='
    ).decode()
